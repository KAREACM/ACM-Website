...
const ExpandableCards: React.FC<ExpandableCardsProps> = ({
  ...
  return (
    <div className={`grid gap-6 ${className} grid-cols-1 sm:grid-cols-2`}>
      {/* 1 column on small, 2 columns on sm and up */}
      {cards.map((card) => {
        ...
        return (
          <div
            ...
            style={{
              border: isSelected ? "none" : "1px solid #e0f2fe",
              ...
              <div className="flex-1 p-6">
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <h3 className="text-lg sm:text-xl font-bold text-gray-800 mb-3 leading-tight group-hover:text-sky-600 transition-colors duration-300">
                      {card.title}
                    </h3>

                    <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-4 line-clamp-5">
                      {card.description}
                    </p>

                    {/* Category badge */}
                    {card.category && (
                      <span className="inline-block px-3 py-1 bg-sky-100 text-sky-800 rounded-full text-xs sm:text-sm font-semibold border border-sky-300">
                        {card.category}
                      </span>
                    )}
                  </div>
                  ...
                  <div className="pt-6 border-t border-sky-200">
                    <div className="flex flex-col sm:flex-row items-center justify-between">
                      ...
                      <a
                        ...
                        className="ml-0 sm:ml-6 px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-xl hover:from-blue-600 hover:to-blue-700 transition-all duration-300 text-sm font-bold shadow-xl hover:shadow-2xl transform hover:scale-105 border-2 border-blue-400 hover:border-blue-300 whitespace-nowrap"
...
const BlogPage: React.FC = () => {
  const [blogs, setBlogs] = useState<Card[]>([]); // dynamic blogs from backend
  ...
  return (
    ...
    >
      ...
      <div className="fixed inset-0 pointer-events-none" style={{ zIndex: 0 }}>
        <div
          className="absolute -top-40 -left-40 w-[350px] sm:w-[550px] h-[350px] sm:h-[550px] rounded-full"
          style={{
            background:
        ...
        <div
          className="absolute -bottom-40 -right-40 w-[350px] sm:w-[550px] h-[350px] sm:h-[550px] rounded-full"
          style={{
            background:
        ...
        <div
          className="absolute top-1/4 right-1/4 w-[250px] sm:w-[350px] h-[250px] sm:h-[350px] rounded-full"
          style={{
            background:
        ...
        <div
          className="absolute bottom-1/4 left-1/4 w-[250px] sm:w-[350px] h-[250px] sm:h-[350px] rounded-full"
          style={{
            background:
      ...
      <div className="relative" style={{ zIndex: 10 }}>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center relative">
              <div className="absolute inset-0 flex items-center justify-center opacity-5 select-none pointer-events-none">
                <div className="text-8xl sm:text-9xl font-black text-sky-200 leading-none">
                  BLOGS
                </div>
              </div>
              <div className="relative z-10 px-4">
                <h1 className="text-3xl sm:text-5xl font-black mb-3 sm:mb-4 leading-tight text-gray-800">
                  KARE ACM Blogs
                </h1>
                <div className="w-24 sm:w-32 h-1.5 sm:h-2 bg-gradient-to-r from-sky-400 to-sky-500 rounded-full mx-auto mb-6"></div>
                <p className="text-gray-700 text-base sm:text-xl max-w-xl sm:max-w-3xl mx-auto leading-relaxed">
                  Discover cutting-edge insights in technology, quantum
                  computing, AI, and more from our student chapter.
        ...
        <div className="px-4 sm:px-8 pb-8">
          <div className="max-w-6xl mx-auto">
            <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-sky-200 p-5 sm:p-6 mb-8">
              <div className="flex flex-col lg:flex-row gap-4">
                ...
                <div className="flex-1 relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 border border-sky-200 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-sky-500 outline-none bg-white text-gray-700 placeholder-gray-500 text-sm sm:text-base"
                  />
                  {searchTerm && (
                    <button
                      onClick={() => setSearchTerm("")}
                      className="absolute right-3 top-1/2 transform -translate-y-1/2 text-sky-500 hover:text-gray-600 transition-colors"
                    >
                      <X className="w-5 h-5" />
                    </button>
                  )}
                ...
                <div className="flex items-center gap-3">
                  ...
                  <select
                    ...
                    className="px-4 py-3 border border-sky-200 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-sky-500 outline-none bg-white text-gray-700 font-semibold text-sm sm:text-base"
                  >
                ...
                {(searchTerm || selectedCategory !== "All") && (
                  <button
                    onClick={clearSearch}
                    className="px-6 py-3 text-sky-600 hover:text-sky-800 font-semibold transition-colors text-sm sm:text-base whitespace-nowrap"
                  >
                    Clear Filters
                  </button>
                )}
              ...
              {/* Search Results Info */}
              <div className="mt-4 text-sm sm:text-base text-gray-700 font-semibold">
